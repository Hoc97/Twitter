export const USERS_MESSAGES = {
  ...
  DATE_OF_BIRTH_MUST_BE_ISOSTRING: 'Date of birth must be ISO String',
  ...
  GET_MY_INFO_SUCCESS: 'Get my info success',
  ...
  UPDATE_PROFILE_SUCCESS: 'Update my profile success',
